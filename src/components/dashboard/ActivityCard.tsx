...
export default function ActivityCard() {
  const activityData = Array.from({ length: 35 }, () => Math.floor(Math.random() * 5));
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-start justify-between">
        <div>
          <h3 className="text-lg font-semibold text-slate-100">Learning Activity</h3>
          <p className="mt-1 text-sm text-slate-300">Recent interactions and engagement</p>
        </div>
